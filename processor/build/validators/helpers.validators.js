...
exports.region =
  exports.array =
  exports.optional =
  exports.getValidateMessages =
  exports.standardUrl =
  exports.standardKey =
  exports.standardNaturalNumber =
  exports.standardEmail =
  exports.standardString =
    void 0;
...
const standardNaturalNumber = (path, message) => [
  ...
  [
    [
      required((value) =>
        validator_1.default.isNumeric(String(value), { no_symbols: true })
      ),
      message,
    ],
  ],
...
const standardKey = (path, message) => [
  ...
  [
    [
      required(
        (value) =>
          validator_1.default.isLength(String(value), { min: 2 }) &&
...
const region = (path, message) => [
  ...
  [
    [
      required(
        required((value) =>
          validator_1.default.isIn(value, [
            'us-central1.gcp',
            'us-east-2.aws',
            'europe-west1.gcp',
            'eu-central-1.aws',
